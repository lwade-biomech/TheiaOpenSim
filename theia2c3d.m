...
%
% INPUT
%   fname           - full path to a Theia C3D file
%   fileout         - output C3D filename (default: original name with
%                     '_Theia' suffix)
%   TRCoutput       - logical flag to export a TRC file
%   filter_freq     - low-pass filter cutoff frequency (Hz). Leave empty
%                     for no filtering.
%   crop            - logical flag to crop data to the interval where all
%                     body segments are available
%   show_animation  - logical flag to display marker animation
%
...
joint_coordinates = [{"pelvis"},{"worldbody"},{"pelvis"};...
    ...
    {"knee_l"},{"l_thigh"},{"l_shank"};...
    {"ankle_l"},{"l_shank"},{"l_foot"};...
    {"mtp_l"},{"l_foot"},{"l_toes"};...
    {"torso"},{"worldbody"},{"torso"};...
    {"shoulder_r"},{"torso"},{"r_uarm"};...
    {"elbow_r"},{"r_uarm"},{"r_larm"};...
    {"wrist_r"},{"r_larm"},{"r_hand"};...
    {"shoulder_l"},{"torso"},{"l_uarm"};...
    {"elbow_l"},{"l_uarm"},{"l_larm"};...
    {"wrist_l"},{"l_larm"},{"l_hand"};...
    {"head"},{"worldbody"},{"head"}];
